...
contract PredictionTour is Ownable, Pausable, ReentrancyGuard {
    ...
    function _safeLockRound(
        ...
        emit LockRound(epoch, roundId, round.lockPrice, round.totalAmount);
    }
    ...
    function _startRound(uint256 epoch) internal {
        ...
        emit StartRound(
            ...
            block.timestamp + (2 * intervalSeconds)
        );
    }
    ...
    function setToken(IERC20 _token) public whenPaused onlyOwner {
        token = _token;
    }
